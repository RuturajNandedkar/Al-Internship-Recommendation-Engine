  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row bg-[#0a0a0f] overflow-hidden">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-[#12121c] items-center justify-center p-12 overflow-hidden border-r border-white/5">
        ...
        <div className="relative z-10 max-w-lg">
          ...
          <h1 className="text-[56px] font-display font-bold text-white leading-[1.1] mb-8 tracking-tight">
            Start your <br/><span className="text-gradient">professional journey</span> today.
          </h1>

          <div className="space-y-6">
            {[
              "Join a community of 10,000+ interns",
              "Get matched with exclusive opportunities",
              "Track your skill growth with AI insights",
              "Build a profile that stands out to recruiters"
            ].map((feature, i) => (
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-12 relative overflow-y-auto">
        <div className="w-full max-w-[420px] animate-fadeIn py-8">
          ...
          <header className="mb-10">
            <h2 className="text-[36px] font-display font-bold text-white mb-3">Join InternAI</h2>
            <p className="text-[#5a5a78] font-medium">Create your account and start matching.</p>
          </header>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              <label className="text-[12px] font-mono font-bold uppercase tracking-widest text-[#5a5a78] pl-1">Full Name</label>
              <input
                type="text"
                required
                value={name}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-2">
                <label className="text-[12px] font-mono font-bold uppercase tracking-widest text-[#5a5a78] pl-1">Password</label>
                <div className="relative group">
                  <input
                    ...
                    className="w-full bg-[#1a1a28] border border-white/5 rounded-2xl px-5 py-4 text-white placeholder:text-white/10 focus:outline-none focus:border-accent/50 focus:ring-4 focus:ring-accent/10 transition-all pr-12 text-sm"
                    placeholder="••••••••"
                  />
                  <button 
                    type="button"
              ...
              <div className="space-y-2">
                <label className="text-[12px] font-mono font-bold uppercase tracking-widest text-[#5a5a78] pl-1">Confirm</label>
                <div className="relative group">
                  <input
          ...
          <div className="mt-8 flex items-center gap-4">
            ...
            <span className="text-[11px] font-mono font-bold text-[#5a5a78] uppercase tracking-widest">or sign up with</span>
            <div className="h-[1px] flex-1 bg-white/5"></div>
          </div>
          ...
          <div className="mt-8">
            <button 
              ...
              className="w-full bg-[#1a1a28] border border-white/5 hover:border-white/10 rounded-2xl py-4 flex items-center justify-center gap-3 transition-all disabled:opacity-60 disabled:cursor-wait"
            >
              {googleLoading ? (
              ...
              <span className="text-white font-bold">{googleLoading ? 'Connecting...' : 'Continue with Google'}</span>
            </button>
          </div>

          <p className="mt-10 text-center text-[#5a5a78] font-medium">
            Already a member?{" "}
            <Link to="/login" className="text-accent2 hover:underline underline-offset-4 decoration-accent2/30 transition-all font-bold">
              Sign In
            </Link>
          </p>
        </div>
