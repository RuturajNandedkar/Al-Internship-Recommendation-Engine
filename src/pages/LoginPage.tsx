        ...
        <div className="w-full max-w-[420px] animate-fadeIn">
          ...
          <div className="mt-8">
            <button 
              ...
              className="w-full bg-white/5 border border-white/10 hover:border-white/20 hover:bg-white/10 rounded-2xl py-4 flex items-center justify-center gap-3 transition-all group disabled:opacity-60 disabled:cursor-wait"
            >
              {googleLoading ? (
