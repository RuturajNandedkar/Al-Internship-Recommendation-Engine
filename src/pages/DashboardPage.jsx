  ...
  return (
    <div className="stat-card group cursor-default">
      <div className="flex items-center gap-4">
        <div className="w-13 h-13 rounded-2xl flex items-center justify-center shadow-sm transition-transform duration-300 group-hover:scale-110" style={{ width: '52px', height: '52px', background: 'linear-gradient(135deg, #eef2ff, #e0e7ff)' }}>
  ...
  return (
    <div className="w-full bg-gray-100 rounded-full h-3.5 overflow-hidden progress-bar-animated">
      <div
        ...
        style={{ width: `${pct}%`, background: gradients[color] || gradients.primary }}
      />
    </div>
  );
}
              ...
              <>
                ...
                {dashboard.analytics && (
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {/* Domain Distribution */}
                    {dashboard.analytics.domainDistribution?.length > 0 && (
                    ...
                    {/* Score Trend */}
                    {dashboard.analytics.scoreTrend?.length > 0 && (
                      <div className="card-premium p-6">
          ...
          <div className="space-y-4">
            {saved.length === 0 ? (
              <div className="text-center py-16 card-premium">
                <div className="w-18 h-18 rounded-3xl flex items-center justify-center mx-auto mb-5" style={{ width: '72px', height: '72px', background: 'linear-gradient(135deg, #eef2ff, #ede9fe)' }}>
                ...
                {history.map((item) => (
                  ...
                  >
                    ...
                    <div className="flex flex-wrap gap-1.5 mb-3">
                      {item.profileSnapshot?.skills?.map((s) => (
            ...
            {resumeResult && (
              <>
                ...
                <div className="card-premium p-6">
                  ...
                  <div className="space-y-3">
                    {resumeResult.recommendations?.slice(0, 5).map((r, i) => (
                      <div
                        key={i}
                        className="flex items-center justify-between py-2 border-b border-gray-50 last:border-0"
                      >
